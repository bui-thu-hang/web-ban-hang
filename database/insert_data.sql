...
insert into role(rolecode,rolename) values('ADMIN','Quan trị');
insert into role(rolecode,rolename) values('USER','Người dùng');

insert into user(username,password,phoneemail,status)
