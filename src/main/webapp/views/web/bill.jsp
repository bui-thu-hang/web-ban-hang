btnAddOrUpdateNew<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ include file="/common/taglib.jsp" %>
<c:url var="cartAPI" value="/api/pay"/>
        ...
        <div class="container py-5">
                <h4>Mẫu liên hệ</h4>
                 <form id="frm1" method="get" action="/thanh-toan" onsubmit="return kiemtra()" >
                    ...
                    <!-- <button class="btn btn-success" id="btnAddOrUpdateNew" type="submit">Đặt hàng</button> -->
                    <!-- <a href="/trang-chu" class="btn btn-sm btn-success">Đặt hàng</a>  -->
                    <a class="btn btn-success" href="<c:url value='/trang-chu'/>">Đặt hàng</a> 
                    <!-- <button class=" btn btn-success" type="button" id="btnPay">Đặt hàng</button> -->
        ...
        <table class="table table-bordered table-striped">           
            ...
            <tbody>         
                ...
                <tr>                                      
                    ...
                    <td>
                        <input type="text" readonly="readonly" min="1" style="width:60px; text-align: center;" id="quantity_${item.id}" name="numberAdd[]" value="${item.numberAdd}">
                    </td>                                     				                                       
                </tr>
                </c:forEach>
            </tbody>
